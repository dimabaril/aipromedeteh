...
export default function FinishSection() {
  return (
    <section className="w-full mx-auto flex flex-col items-center min-h-screen justify-around">
      <div></div>
      <div className="relative w-full max-w-[1200px] h-[600px] rounded-3xl p-10  flex flex-col justify-between overflow-hidden">
        ...
        <div className="grid grid-cols-[1fr_2fr_3fr] grid-rows-[2fr_1fr] h-full w-full gap-0 relative z-0">
          ...
          <div className="flex p-10 border-[#cec1ff7d] border-b border-r items-start">
            <h1 className="border px-6 py-2 rounded-full text-3xl">Контакты</h1>
          </div>
          ...
          <div className="p-10 flex flex-col">
            <div className="text-3xl">+7 925 735 3351</div>
            <div className="text-2xl">Артур Ширкин</div>
          </div>
        </div>
      </div>
      <div></div>
