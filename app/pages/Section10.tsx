      ...
      <div className="w-full max-w-[1440px] relative p-10">
        ...
        <div className="flex">
          ...
          <div className="flex-1 flex items-center p-10">
            <div className="bg-[#5A3B5D]/30 rounded-3xl px-8 py-6  text-4xl w-full text-left translate-y-2/3 backdrop-blur-xs z-10">
        ...
        <div className=" text-2xl max-w-3xl p-10">
          Это позволяет делать любые тонкие настройки
          <br />
          решениядля специальных потребностей
        </div>
      </div>
    </section>
  );
